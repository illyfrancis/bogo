...
define([
    ...
    var Repository = {
        ...
        loadAll: function (onLoaded, context) {
            ...
            var loaders = ['loadAccounts', 'loadSecurities', 'loadReportSchema', 'loadTransactionTypes', 'loadTransactionTypesWithRoot', 'loadPreferences'],
                options = {};
        ...
        loadTransactionTypesWithRoot: function(options) {
            var data = {
                name: 'Root',
                nodes: [{
                    name: "TRADE",
            ...
            this.transactionTypesWithRoots = new TreeRoot(data);

            options = options || {};
            if (options.success) {
                console.log('transaction types with root loaded');
                options.success();
            }
        },
